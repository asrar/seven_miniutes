...
import 'package:seven_minutes/pitem/GetPrayerPosts.dart';
...
class HomePrayer extends StatefulWidget {
  @override
  _HomePrayerState createState() => _HomePrayerState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // Audio(),
          Expanded(
            child: Observer<List<GetPrayerPosts>>(
              stream: manager.productList,
              onSuccess: (context, data) {
                // snapshot.data ?? 0;

                List<GetPrayerPosts> _productList = data;
                print("printing from list tile");
                GetPrayerPosts _post1 = _productList[0];
                ...
                return ListView.builder(
                  // for Auto-scrolling binding controller in build method
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      print("printing from list tile");
                      GetPrayerPosts _post = _productList[0];
