...
class RememberHadithLayout extends StatefulWidget {
  @override
  _RememberHadithLayoutState createState() => _RememberHadithLayoutState();
}



class _RememberHadithLayoutState extends State<RememberHadithLayout> {
