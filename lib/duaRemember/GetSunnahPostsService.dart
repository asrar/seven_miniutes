...
class GetSunnahPostsService {
  ...
  static Future<List<GetSunnahPosts>> browse() async {
    ...
    print("Query URL -->  https://7minapp.s3bits.com/api/getposts?item_category_id=3&user_id=3&post_date=${year}-${month}-${day}");
    http.Response   response = await http.post(Uri.parse("https://7minapp.s3bits.com/api/getposts?item_category_id=3&user_id=3&post_date=${year}-${month}-${day}"),headers: {
